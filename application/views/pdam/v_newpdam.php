				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Form Input Stand Meter PDAM Baru</h2>
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo base_url(); ?>pdam/tambah_pdam">
										...
										<div class="item form-group form-check">
											...
											<div class="col-md-4 col-sm-6 ">
												<input type="text" name="penggunaan" id="first-name" class="form-control" required>
											</div>
										</div>
